...
describe('cookieandkate', () => {
  ...
  beforeAll(async () => {
    const source = await testAsset('cookieandkate.com/ExtraVegetableFriedRice.html')
...
//    debug(util.inspect(result, {depth: 4}))
  ...
  test('description', async () => {
    expect(result.description).toMatch(/^Learn how to make vegetable fried rice/)
  })
  ...
  test('image_url', async () => {
    expect(result.image_url).toBe("https://cookieandkate.com/images/2017/05/vegetable-fried-rice.jpg")
  })
